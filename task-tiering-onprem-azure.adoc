...
+
** Eine HTTPS-Verbindung über Port 443 zum Cloud Tiering Service und zum Azure Blob Objekt-Storage (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-azure.html#endpoints-contacted-for-day-to-day-operations["Siehe die Liste der Endpunkte"^])
