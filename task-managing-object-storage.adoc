...
. Ziehen Sie auf der Seite Erweiterte Einstellungen den zu verwendenden Objektspeicher an den Speicherort für den Spiegelobjektspeicher.
+
...
. Klicken Sie auf der Seite Erweiterte Einstellungen auf das Menüsymbol für das Aggregat und wählen Sie *Reiseziele austauschen*.
+
...
. Klicken Sie auf der Seite Erweiterte Einstellungen auf das Menüsymbol für das Aggregat und wählen Sie *Unmirror Object Store*.
+
