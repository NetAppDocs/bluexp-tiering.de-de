...
+
** Eine HTTPS-Verbindung über Port 443 zum Cloud Tiering Service und zu Ihrem S3 Objekt-Storage (https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-set-up-networking-aws.html#endpoints-contacted-for-day-to-day-operations["Siehe die Liste der Endpunkte"^])
