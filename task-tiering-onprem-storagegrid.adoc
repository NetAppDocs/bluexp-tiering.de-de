...
Lizenzierung:: Für Ihr BlueXP Konto ist keine BlueXP Tiering-Lizenz erforderlich. Auch für das Daten-Tiering auf StorageGRID ist keine FabricPool Lizenz auf dem ONTAP Cluster erforderlich.
