...
* Ein ONTAP-Cluster vor Ort, auf dem ONTAP 9.4 oder höher ausgeführt wird, und eine Verbindung über einen vom Benutzer angegebenen Port zu StorageGRID. https://docs.netapp.com/us-en/bluexp-ontap-onprem/task-discovering-ontap.html["Entdecken Sie ein Cluster"^].
...
Lizenzierung:: In Ihrer BlueXP  Organisation ist keine BlueXP  Tiering Lizenz erforderlich. Auch ist für das Tiering von Daten auf StorageGRID keine FabricPool Lizenz auf dem ONTAP Cluster erforderlich.
